					...
					$.ajax({
						...
						if(success == 1){
							...
							if($("#mainCity").val() == "88000000"){
								...
								location.href = 'message-province=.htm'/*tpa=http://www.disneyenglish.com/index/message?province=*/+$("#city1").val()+'&city='+$("#city2").val()+'&pt='+__pt;
								/*var toUrl = '/index/message?province='+$("#city1").val()+'&city='+$("#city2").val()+'&pt='+__pt;
								setTimeout("location.href ='"+toUrl+"'",5000);*/
							}else{
								ga('send', 'event', 'button', 'onClick', 'signUp');
								location.href = 'message-province=.htm'/*tpa=http://www.disneyenglish.com/index/message?province=*/+$("#city1").val()+'&city='+$("#mainCity").val()+'&pt='+__pt;
