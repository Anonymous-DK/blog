...
mejs.MediaElementDefaults={mode:"auto",plugins:["flash","silverlight","youtube","vimeo"],enablePluginDebug:false,type:"",pluginPath:mejs.Utility.getScriptPath(["mediaelement.js"/*tpa=http://www.disneyenglish.com/build/mediaelement.js*/,"mediaelement.min.js"/*tpa=http://www.disneyenglish.com/build/mediaelement.min.js*/,"mediaelement-and-player.js"/*tpa=http://www.disneyenglish.com/build/mediaelement-and-player.js*/,"mediaelement-and-player.min.js"/*tpa=http://www.disneyenglish.com/build/mediaelement-and-player.min.js*/]),flashName:"flashmediaelement.swf"/*tpa=http://www.disneyenglish.com/build/flashmediaelement.swf*/,flashStreamer:"",enablePluginSmoothing:false,silverlightName:"silverlightmediaelement.xap"/*tpa=http://www.disneyenglish.com/build/silverlightmediaelement.xap*/,defaultVideoWidth:480,defaultVideoHeight:270,pluginWidth:-1,pluginHeight:-1,pluginVars:[],timerRate:250,startVolume:0.8,
...
b.pluginPath+b.silverlightName+'" /></object>';break;case "flash":if(mejs.MediaFeatures.isIE){a=document.createElement("div");k.appendChild(a);a.outerHTML='<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab" id="'+l+'" width="'+f+'" height="'+h+'"><param name="movie" value="'+b.pluginPath+b.flashName+"?x="+new Date+'" /><param name="flashvars" value="'+d.join("&amp;")+'" /><param name="quality" value="high" /><param name="bgcolor" value="#000000" /><param name="wmode" value="transparent" /><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="true" /></object>'}else k.innerHTML=
...
function(l){if(l.which===1){p=true;n(l);f(document).bind("http://www.disneyenglish.com/build/mousemove.dur",function(q){n(q)}).bind("http://www.disneyenglish.com/build/mouseup.dur",function(){p=false;h.hide();f(document).unbind(".dur")});return false}}).bind("mouseenter",function(){f(document).bind("http://www.disneyenglish.com/build/mousemove.dur",function(l){n(l)});mejs.MediaFeatures.hasTouch||h.show()}).bind("mouseleave",function(){if(!p){f(document).unbind(".dur");h.hide()}});e.addEventListener("progress",function(l){a.setProgressRail(l);a.setCurrentRail(l)},false);e.addEventListener("timeupdate",
...
e.setMuted(false);e.setVolume(m)},q=false,i=false;g.hover(function(){k.show();i=true},function(){i=false;!q&&d=="vertical"&&k.hide()});k.bind("mouseover",function(){i=true}).bind("mousedown",function(j){l(j);f(document).bind("http://www.disneyenglish.com/build/mousemove.vol",function(m){l(m)}).bind("http://www.disneyenglish.com/build/mouseup.vol",function(){q=false;f(document).unbind(".vol");!i&&d=="vertical"&&k.hide()});q=true;return false});g.find("button").click(function(){e.setMuted(!e.muted)});e.addEventListener("volumechange",function(){if(!q)if(e.muted){p(0);
