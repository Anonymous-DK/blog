    ...
    for(i=0;i<para.length;i++)    {
     ...
     if(tempstr.substring(0,pos) == strname) {  
		...
		if (tempstr.substring(pos+1) != ""){
			 var url = "https://www.disneyenglish.com/leadform/url_setcookie_ajax.php";
...
$(document).ready(function(){
  	function InitAjax()
				...
				$("#sign_submit").click(function(){
					...
					$.ajax({
						type: "POST",
						url:  "https://www.disneyenglish.com/leadform/reg_ajax_cn_promotionslider.php",
						crossDomain: true,
						dataType: "xml", 
						data: data,
						timeout:60000
						...
						if(success == 1){
							...
							location.href = 'https://www.disneyenglish.com/index/message?error=1';
						}else{
							...
							//location.href = 'https://www.disneyenglish.com/index/message?province='+user_province+'&city='+user_city;
							if($("#mainCity").val() == "88000000"){
								//就选择下面的省市
								ga('send', 'event', 'button', 'onClick', 'signUp');
								location.href = 'https://www.disneyenglish.com/index/message?province='+$("#city1").val()+'&city='+$("#city2").val()+'&pt='+__pt;
								/*var toUrl = '/index/message?province='+$("#city1").val()+'&city='+$("#city2").val()+'&pt='+__pt;
								setTimeout("location.href ='"+toUrl+"'",5000);*/
							}else{
								ga('send', 'event', 'button', 'onClick', 'signUp');
								location.href = 'https://www.disneyenglish.com/index/message?province='+$("#city1").val()+'&city='+$("#mainCity").val()+'&pt='+__pt;
								/*var toUrl = '/index/message?province='+$("#city1").val()+'&city='+$("#mainCity").val()+'&pt='+__pt;
								setTimeout("location.href ='"+toUrl+"'",5000);*/
							}
